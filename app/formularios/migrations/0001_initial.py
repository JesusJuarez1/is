# Generated by Django 4.2.13 on 2024-06-15 06:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('response', models.ManyToManyField(related_name='response', to='formularios.answer')),
                ('response_to', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='response_to', to='formularios.form')),
            ],
        ),
        migrations.CreateModel(
            name='Questions',
            fields=[
                ...
                ('choices', models.ManyToManyField(related_name='choices', to='formularios.choices')),
            ],
        ),
        migrations.AddField(
            model_name='form',
            name='questions',
            field=models.ManyToManyField(related_name='questions', to='formularios.questions'),
        ),
        migrations.AddField(
            model_name='answer',
            name='answer_to',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='answer_to', to='formularios.questions'),
        ),
    ]
