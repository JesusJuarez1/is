...
from usuario.models import CaseiUserManager, CaseiUser
...
class Form(models.Model):
    ...
    creator = models.ForeignKey(CaseiUser, on_delete = models.CASCADE, related_name = "creator")
...
class Responses(models.Model):
    ...
    responder = models.ForeignKey(CaseiUser, on_delete = models.CASCADE, related_name = "responder", blank = True, null = True)
